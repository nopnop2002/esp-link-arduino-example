...
uint16_t const tcpPort PROGMEM = 9876;

// Initialize a connection to esp-link using the software serial port for SLIP
// and Initialize a connection to esp-link using the normal hardware serial port for debug messages.
